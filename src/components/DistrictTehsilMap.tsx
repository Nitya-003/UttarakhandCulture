...
export default function DistrictTehsilMap({districtName}: { districtName: string }) {
    return (
        <div
            className="relative w-full aspect-square bg-emerald-50/50 rounded-full border-4 border-white shadow-inner flex items-center justify-center overflow-hidden p-8">
            <div
                className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/cartographer.png')]"/>
