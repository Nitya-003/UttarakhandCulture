                        ...
                        <div className="bg-muted/20 p-8 rounded-3xl border border-border/50">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-white p-4 rounded-xl shadow-sm">
                                    <span
                                        className="text-xs text-muted-foreground uppercase tracking-wider block mb-1">Area</span>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                {district.subdivisions.map((tehsil) => (
                                    <div key={tehsil}
                                         className="px-3 py-2 bg-sky-50 text-sky-800 rounded-lg text-sm font-medium border border-sky-100">
                                        {tehsil}
                                    </div>
                                ))}
                            </div>
